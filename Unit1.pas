...
begin
  ...
  Posib:= AncCam * AltCam;
  //ciclo que se encarga de verificar las bombas e indicar en que posición se
...
//Timer que se encarga de medir el tiempo que se mostrará en el cronometro
...
//numero de bombas que habrá en juego.
...
//Coloca en las casillas el simbolo de interrogación si está activo.
